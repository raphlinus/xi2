...
// Note: this file is copy-pasted from xi-editor/rust/core-lib/src with minimal
// adaptation.
...
/// `Default` value.
///
/// TODO: candidate for demolition, it's likely that fancy edit operations like transpose will
...
///
/// TODO: move to a different file, it's not specific to selection.
